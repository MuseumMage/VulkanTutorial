...
{
	// Shader
	auto vertShaderCode = TutUtils::readFile(VERTEX_SHADER_PATH);
	auto fragShaderCode = TutUtils::readFile(FRAG_SHADER_PATH);
...
void HelloTriangleApplication::drawFrame()
{
	...
	// Update the uniform buffer after acquiring the image
...
void HelloTriangleApplication::destroyTextureImage()
{
...
void HelloTriangleApplication::createTextureSampler()
{
	...
	samplerInfo.mipmapMode = VK_SAMPLER_MIPMAP_MODE_LINEAR; // linear blending between mip levels
...
void HelloTriangleApplication::destroyDepthResources()
{
                                                     ...
                                                     VkImageLayout newLayout, uint32_t mipLevels)
{
	...
	// Shader reads should wait on transfer writes, specifically the shader reads in the fragment shader, because that's where we're going to use the texture
